...
export default hopeTheme({
  ...
  hostname: "https://kyokukong.github.io",
  ...
  footer: "愛してくれって何度叫んだって。君が見てんのはあたしじゃないな？",

  displayFooter: true,

  blog: {
    description: "きょく，立刻轉生成為機器小狗。",
    intro: "/intro.html",
    medias: {
      BiliBili: "https://space.bilibili.com/1220441567",
      Email: "mailto:hf4develop@163.com",
  ...
  plugins: {
    comment: {
      provider: "Giscus",
      repo: "KyokuKong/kyokuBlog-Giscus",
      repoId: "R_kgDOKrexhQ",
      category: "Announcements",
      categoryId: "DIC_kwDOKrexhc4Ca1GQ",
      lazyLoading: true,
    },
    copyCode: {},
    blog: true,
